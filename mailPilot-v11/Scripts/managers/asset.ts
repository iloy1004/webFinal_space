module managers {
    ...
    var atlas_Level1Data = {
        ...
        "frames": [
            ...
            [0, 127, 240, 118],
            [0, 257, 240, 118],
            [21, 400, 98, 104], //stone1
            [134, 399, 111, 105],
            [267, 418, 88, 81],
            [371, 343, 61, 73], //star1
            [377, 430, 60, 58],
            [461, 423, 47, 60],
            [276, 20, 473, 313], //board
            [300, 198, 123, 43], //play btn
            [300, 249, 123, 43], //exit
            [36, 532, 51, 47],
            [106,539, 36,37]
        ],
    ...
    var atlas_Level2Data = {
        ...
        "frames": [
            ...
            [17, 139, 234, 112],
            [17, 268, 234, 112],
            [50, 407, 121, 100], //helper
            [50, 506, 121, 100],
            [50, 606, 121, 100],
            [288, 12, 120, 119], //planet1
            [287, 148, 127, 120], //planet2
            [453, 12, 200, 118], //enemy
            [465, 205, 175, 115],
            [459, 395, 187, 119],
            [202, 526, 473, 315], //board
            [226, 706, 122, 43], //play btn
            [226, 756, 122, 43], //exit
        ],
        "animations": {
            "ship": {
    ...
    var atlas_Level3Data = {
        ...
        "frames": [
            ...
            [330, 1760, 145, 51],
            [330, 1821, 145, 51],
            [442, 32, 470, 315], //board
            [462, 212, 125, 43], //play btn
            [462, 263, 125, 43], //exit
        ],
        "animations": {
            "ship": {
    ...
    export class Assets {
        ...
        public static atlas_all: createjs.SpriteSheet;
