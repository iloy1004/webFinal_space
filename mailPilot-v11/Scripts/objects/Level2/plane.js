...
(function (objects) {
    // Plane Class
    var Plane_L2 = (function () {
        function Plane_L2(stage, game) {
            this.stage = stage;
            this.game = game;
        ...
        Plane_L2.prototype.assignControls = function () {
            // Binds key actions
            window.onkeydown = this.onControlDown;
            window.onkeyup = this.onControlUp;
        };
        Plane_L2.prototype.onControlDown = function (e) {
            switch (e.which) {
                case keys.LEFT:
                case keys.A:
                    controls.left = true;
        ...
        Plane_L2.prototype.onControlUp = function (e) {
            switch (e.which) {
                case keys.LEFT:
                case keys.A:
                    controls.left = false;
        ...
        Plane_L2.prototype.update = function () {
        ...
        Plane_L2.prototype.destroy = function () {
            this.engineSound.stop();
            game.removeChild(this.image);
        };
        return Plane_L2;
    })();
    objects.Plane_L2 = Plane_L2;
})(objects || (objects = {}));
